...
class DiagonalRemovedTADAnalyzer:
    ...
    def create_publication_figure(self, output_dir='publication_figures'):
        """
        Create a figure with violin plots (single row, no bootstrap subplots, no grid)
        """
        ...
        # Create figure with single row of violin plots
        fig, violin_axes = plt.subplots(1, 3, figsize=(16, 6))
